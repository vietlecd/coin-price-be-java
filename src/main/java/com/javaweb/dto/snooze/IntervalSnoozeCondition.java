...
@Document(collection = "interval_snooze_conditions")
@Component
public class IntervalSnoozeCondition {
    ...
    // Constructors
    public IntervalSnoozeCondition() {}

    public IntervalSnoozeCondition(String symbol, String conditionType, LocalDateTime startTime, LocalDateTime endTime, String specificTime) {
        this.symbol = symbol;
