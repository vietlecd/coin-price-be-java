...
@Document(collection = "listing_snooze_conditions")
@Component
public class ListingSnoozeCondition {
    ...
    // Constructors
    public ListingSnoozeCondition() {}

    public ListingSnoozeCondition(String symbol, String conditionType, LocalDateTime startTime, LocalDateTime endTime, String specificTime) {
        this.symbol = symbol;
